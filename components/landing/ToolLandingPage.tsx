...
export function ToolLandingPage() {
  return <div className={styles.page} data-landing-page>
    ...
    <main>
      ...
      <section className={styles.delivery}><div className={styles.inner}><Heading eyebrow="Da solução à operação" title="Não entregamos apenas acesso à ferramenta. Ajudamos a colocá-la para funcionar." /><ul>{deliveries.map(item => <li key={item}><span>✓</span>{item}</li>)}</ul></div></section>
