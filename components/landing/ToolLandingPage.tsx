...
export function ToolLandingPage() {
  return <div className={styles.page} data-landing-page>
    ...
    <main>
      ...
      <section className={styles.delivery}><div className={styles.inner}><Heading eyebrow="Da solução à operação" title={<>Não entregamos apenas acesso à ferramenta. Ajudamos a <span className={styles.noBreak}>colocá-la</span> para funcionar.</>} /><ul>{deliveries.map(item => <li key={item}><span>✓</span>{item}</li>)}</ul></div></section>
      ...
      <section className={styles.finalCta}><div><Eyebrow light>Próximo passo</Eyebrow><h2>Conte o que sua empresa precisa colocar para funcionar.</h2><p>Em poucos minutos, você nos ajuda a entender sua necessidade e preparar uma configuração inicial para nossa conversa.</p><PrimaryCta light>Quero implantar uma solução</PrimaryCta><small>Questionário rápido. Sem compromisso de contratação.</small></div></section>
    </main>
