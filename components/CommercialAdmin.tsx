...
export function CommercialParameters(){
 ...
 const newResource=()=>setEditing({codigo:'',categoria:'',nome:'',descricao:'',beneficios:[],objetivo_padrao:'',entregas_padrao:[],recursos_envolvidos:[],pre_requisitos:'',criterio_conclusao:'',ordem_implantacao:'',semana_sugerida:'Semana 1',duracao_padrao:7,dependencias:'',descricao_tecnica:'',utiliza_plataforma_nimble:false,tipo:'Implantação',ui:1,valor_mensal:'',valor_avulso:'',obrigatoriedade:'Padrão',responsavel:'Escala Vendas',prioridade:'Média',observacoes:'',ativo:true});
 ...
 {editing&&<div className="modal"><section><h2>{editing.id?'Editar':'Novo'} solução</h2><div className="solution-template-form">
  <fieldset><legend>1 · Comercial</legend><div className="resource-form">
   ...
   <label className="wide validation-option"><input type="checkbox" checked={editing.utiliza_plataforma_nimble===true} onChange={e=>setEditing({...editing,utiliza_plataforma_nimble:e.target.checked})}/><span>Utiliza a estrutura da Plataforma Nimble<small className="field-help">Quando selecionado, o projeto incluirá automaticamente AUT-001, TRN-001 e PLA-001.</small></span></label>
  </div></fieldset>
