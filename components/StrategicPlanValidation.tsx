...
export function StrategicPlanValidation({data,plan}:{data:any;plan:any;update?:(id:string,body:any)=>void}){
 ...
 return <section className="admin-section plan-premium strategic-validation" id="plan-editor">
  ...
  <section className="strategic-generation-note"><b>Documento executivo automático</b><p>O cenário, o objetivo estratégico, as prioridades, o cronograma, as soluções recomendadas e a jornada serão consolidados automaticamente, sem reproduzir o Relatório da Reunião Estratégica.</p></section>
